...
import com.gaozhidong.android.noteapp.Adapter.NineGridImageViewAdapter;
...
public class NineGridImageView<T> extends ViewGroup {
    ...
    public void setImagesData(List lists){
        ...
        int[] gridParam = calculateGridParam(lists.size()); //用数据的大小计算出需要多少行多少列
        ...
        if(mImgDataList == null){
            ...
            while (i < lists.size()){
                ...
                addView(iv,generateDefaultLayoutParams());  //真正加入到布局中
                i++;
            }
        }else {
